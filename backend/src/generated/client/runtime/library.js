...
var Wo = Z((ff, Jo) => {
  ...
  function ri(e) {
    ...
    if (
      !Ju.supportsColor(e) || e && !e.isTTY || process.platform === "win32" ||
...
typeof process < "u" &&
  ({ FORCE_COLOR: Bn, NODE_DISABLE_COLORS: wo, NO_COLOR: xo, TERM: Po } =
    process.env || {},
    vo = process.stdout && process.stdout.isTTY);
var To = {
  enabled: !wo && xo == null && Po !== "dumb" &&
    (Bn != null && Bn !== "0" || vo),
};
function M(e, t) {
  ...
  Ee = (e, t, r) => {
    ...
    if (Wn(e)) {
      ...
      return Object.keys(e).every((n) => {
        let i = e[n];
        return (n in t || jr(o = i) && o[_e]().matcherType === "optional") &&
          Ee(i, t[n], r);
        var o;
      });
    }
...
async function qu(e) {
  try {
    return (await zn.default.readdir(e)).find((r) =>
  ...
  let t = e.e,
    ...
    i =
      `Please refer to the documentation about Prisma's system requirements: ${
        ii("https://pris.ly/d/system-requirements")
      }`,
...
function Ss(e, t, r, n) {
  ...
  for (x = !1;;) {
    if (
      r % 2 && (o = o.times(t), Es(o.d, s) && (i = !0)), r = ee(r / 2), r === 0
    ) {
...
function He(e, t) {
  ...
  } else {return u = nn(T, c + 2, C).times(o + ""),
...
var mp = (e) => e,
  ...
  P = {
    ...
    util: {
      ...
      objId: function (e) {
        return e.__id || Object.defineProperty(e, "__id", { value: ++fp }),
          e.__id;
      },
...
var St = class extends Ye {
  ...
  writeWithItems(r) {
    ...
    r.writeLine("[").withIndent(() => r.writeJoined(Ct, this.items).newLine())
      .write("]"),
...
function Mp(e, t) {
  ...
  n && (n.getField(r)?.markAsError(), Wp(n, e.arguments)),
    t.addErrorMessage((i) => Qs(i, r, e.arguments.map((o) => o.name)));
}
function $p(e, t) {
...
var hn = Symbol(),
  ...
  Me = class {
    constructor(t) {
      t === hn ? Ii.set(this, `Prisma.${this._getName()}`) : Ii.set(
        this,
    ...
    return "transaction" in t && i !== void 0 &&
      ...
      n === r.length ? e._executeRequest(t) : r[n]({
        ...
        query: (s, a = t) => {
          ...
          return a.customDataProxyFetch = qa(o, l),
            a.args = s,
            La(e, a, r, n + 1);
        },
      });
...
async function za(e, t) {
  ...
  let o = await nt(),
    ...
    p;
  throw a && l ? p = Wa(c) : l ? p = Qa(c) : u ? p = Ja(c) : p = Ha(c),
...
function dm(e) {
  ...
  return process.platform !== "win32" &&
    (i = so.default.constants.dlopen.RTLD_LAZY |
...
function uo(e, t, r, n) {
  if (
    !(e !== "postgresql" && e !== "cockroachdb") && r.length > 0 && Em.exec(t)
  ) {
