...
function it(e, t) {
  ...
  } else {return u = yr(S, g + 2, I).times(o + ""),
...
function pn(e) {
  ...
  function i(o) {
    ...
    if (
      o.charCodeAt(0) === 45 ? (o = o.slice(1), s.s = -1) : s.s = 1, Zo.test(o)
    ) sn(s, o);
...
typeof h < "u" &&
  ({ FORCE_COLOR: Pr, NODE_DISABLE_COLORS: wn, NO_COLOR: En, TERM: xn } =
    h.env || {},
    Pn = h.stdout && h.stdout.isTTY);
var is = {
  enabled: !wn && En == null && xn !== "dumb" &&
    (Pr != null && Pr !== "0" || Pn),
};
function F(e, t) {
...
function qs(e, t) {
  ...
  n && (n.getField(r)?.markAsError(), Hs(n, e.arguments)),
    t.addErrorMessage((i) => Xn(i, r, e.arguments.map((o) => o.name)));
}
function Bs(e, t) {
...
function Gs(e, t) {
  ...
  t.addErrorMessage((o) => {
    ...
    return e.constraints.minFieldCount === 1 && e.constraints.maxFieldCount == 1
      ...
      s.push(
        `but you provided ${Jt("and", i.map((a) => o.red(a)))}. Please choose`,
      ),
      e.constraints.maxFieldCount === 1
        ? s.push("one.")
...
var Gt = Symbol(),
  ...
  xe = class {
    constructor(t) {
      t === Gt ? Mr.set(this, `Prisma.${this._getName()}`) : Mr.set(
        this,
    ...
    return "transaction" in t && i !== void 0 &&
      ...
      n === r.length ? e._executeRequest(t) : r[n]({
        ...
        query: (s, a = t) => {
          ...
          return a.customDataProxyFetch = Wi(o, u),
            a.args = s,
            ji(e, a, r, n + 1);
        },
      });
...
function zr(e, t, r, n) {
  if (
    !(e !== "postgresql" && e !== "cockroachdb") && r.length > 0 && Ga.exec(t)
  ) {
...
var Yr = ({ clientMethod: e, activeProvider: t }) => (r) => {
    let n = "", i;
    if (bi(r)) {
