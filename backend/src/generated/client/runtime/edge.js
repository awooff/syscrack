...
typeof y < "u" &&
  ({ FORCE_COLOR: pn, NODE_DISABLE_COLORS: Oi, NO_COLOR: ki, TERM: Di } =
    y.env || {},
    Mi = y.stdout && y.stdout.isTTY);
var za = {
  enabled: !Oi && ki == null && Di !== "dumb" &&
    (pn != null && pn !== "0" || Mi),
};
function V(e, t) {
...
C.inverseTangent = C.atan = function () {
  ...
  if (u.isFinite()) {
    ...
    if (h + 4 <= bn) return s = ce(g, h + 4, v).times(.5), s.s = u.s, s;
  }
  for (
    g.precision = a = h + 10,
      g.rounding = 1,
    ...
    if (
      ...
      if (J = J / S + 2 | 0, h = 0, ue == 1) {
        ...
        for (
          v = l / ($[0] + 1) | 0,
            v > 1 &&
            ($ = e($, v, l), Z = e(Z, v, l), ue = $.length, vt = Z.length),
            ar = ue,
            D = Z.slice(0, ue),
            I = D.length;
          I < ue;
        ...
        do v = 0,
          ...
          u < 0
            ...
            : u === 0 && (v++, D = [0]),
          q[h++] = v,
          u && D[0] ? D[I++] = Z[ar] || 0 : (D = [Z[ar]], I = 1); while (
          (ar++ < vt || D[0] !== void 0) && J--
        );
        A = D[0] !== void 0;
      }
...
function po(e, t, r, n) {
  ...
  for (_ = !1;;) {
    if (
      r % 2 && (o = o.times(t), no(o.d, s) && (i = !0)), r = X(r / 2), r === 0
    ) {
...
function ke(e, t) {
  ...
  } else {return u = xr(F, g + 2, D).times(o + ""),
...
function yu(e, t) {
  ...
  t.addErrorMessage((s) => {
    ...
    return i ? a += ` on model ${s.bold(i.name)}. ${Nt(s)}` : a += ".",
      a += `
...
function ku(e, t) {
  ...
  t.addErrorMessage((o) => {
    ...
    return e.constraints.minFieldCount === 1 && e.constraints.maxFieldCount == 1
      ...
      s.push(
        `but you provided ${Or("and", i.map((a) => o.red(a)))}. Please choose`,
      ),
      e.constraints.maxFieldCount === 1
        ? s.push("one.")
...
var kr = Symbol(),
  ...
  Ae = class {
    constructor(t) {
      t === kr ? Cn.set(this, `Prisma.${this._getName()}`) : Cn.set(
        this,
...
function No(e, t, r) {
  let n = ye(r);
  return !t.result || !(t.result.$allModels || t.result[n]) ? e : qu({
    ...e,
    ...
    return "transaction" in t && i !== void 0 &&
      ...
      n === r.length ? e._executeRequest(t) : r[n]({
        ...
        query: (s, a = t) => {
          ...
          return a.customDataProxyFetch = Es(o, l),
            a.args = s,
            gs(e, a, r, n + 1);
        },
      });
...
function Xn(e, t, r, n) {
  if (
    !(e !== "postgresql" && e !== "cockroachdb") && r.length > 0 && Bc.exec(t)
  ) {
